...
--
-- Table structure for table `a1001`
--
...
CREATE TABLE `a1001` (
  ...
  KEY `ac_no` (`ac_no`),
  CONSTRAINT `a1001_ibfk_1` FOREIGN KEY (`ac_no`) REFERENCES `accounts` (`acc`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `a1001`
--

LOCK TABLES `a1001` WRITE;
/*!40000 ALTER TABLE `a1001` DISABLE KEYS */;
/*!40000 ALTER TABLE `a1001` ENABLE KEYS */;
UNLOCK TABLES;
