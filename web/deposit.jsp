...
<%!
    ...
    Student s = new Student(101, "java");
%>
...
<html>
    ...
    <body onload="s()">
        ...
        <div class="container" style="float: left;background-color:#9acfea;height:800px;margin-left: 100px ">
            ...
            <form class="form-horizontal" action="deposit.htm" method="post"  style="margin-left: 200px" >
                ...
                <div class="form-group" style="padding-top:10px">
                    <label for="deposit" class="col-md-3 control-label input-label">AMOUNT:</label>
                    <div class="col-md-3">
                        <input type="text" class="form-control" name="deposit"></input>
                    </div>
                </div>

                <div class="form-group" style="padding-top:10px">
                    <label for="deposit_by" class="col-md-3 control-label input-label">DEPOSIT By:</label>
                    <div class="col-md-3">
                        <input type="text" class="form-control" name="deposit_by" ></input>
                    </div>
                </div>
        ...
        <script language="javascript" type="text/javascript">
                            function m1() {
                                ...
                                window.location.replace("deposit.jsp?x=" + v1);
