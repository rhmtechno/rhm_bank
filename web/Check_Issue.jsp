...
<html>
    ...
    <body>
        ...
        <div class="container" style="float: left;background-color:#9acfea;height:800px;margin-left: 100px ">
            ...
            <form class="form-horizontal" action="checkgn.htm" method="post"  style="margin-left: 200px" >

                <legend class="the-legend">Issue Check</legend>
                ...
                <div class="form-group" style="padding-top:10px">
                    <label for="range" class="col-md-3 control-label input-label">Number Of Page:</label>
                    <div class="col-md-3">
                        <input type="text" class="form-control" name="range" ></input>
                    </div>
                </div>
        ...
        <script language="javascript" type="text/javascript">
                           function m1() {
                               ...
                               window.location.replace("Check_Issue.jsp?x=" + v1);
            <%
            ...
            <%s.setAcc(name);%>
                ...
                if(s=="Account Not Found"){
                    document.getElementById("t2").style.backgroundColor = "red";
                           ...
                           document.getElementById("t1").value = "<%=s.getAcc()%>";
        </script>
