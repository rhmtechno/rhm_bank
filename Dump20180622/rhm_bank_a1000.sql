...
--
-- Table structure for table `a1000`
--
...
CREATE TABLE `a1000` (
  ...
  KEY `ac_no` (`ac_no`),
  CONSTRAINT `a1000_ibfk_1` FOREIGN KEY (`ac_no`) REFERENCES `accounts` (`acc`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `a1000`
--

LOCK TABLES `a1000` WRITE;
/*!40000 ALTER TABLE `a1000` DISABLE KEYS */;
/*!40000 ALTER TABLE `a1000` ENABLE KEYS */;
UNLOCK TABLES;
